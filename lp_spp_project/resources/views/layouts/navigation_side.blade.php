<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-white" id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0 d-flex align-items-center" href="{{ route('dashboard') }}" target="_blank">
            <img src="{{ asset('assets/img/logo-ct.png') }}" class="navbar-brand-img h-100 me-3" alt="main_logo" />
            <span class="font-weight-bold d-flex flex-column">
                <span>SPP - Marhas</span>
    ...
    <div class="collapse navbar-collapse w-auto" style="height: 80%;" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::is('jurusan') || Route::is('jurusan.edit') ? 'active' : '' }}" href="{{ route('jurusan') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::is('angkatan') || Route::is('angkatan.edit') ? 'active' : '' }}" href="{{ route('angkatan') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>office</title>
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="nav-link-text ms-1">Angkatan</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Route::is('kelas') || Route::is('kelas.edit') ? 'active' : '' }}" href="{{ route('kelas') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>office</title>
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::is('siswa') || Route::is('siswa.edit') || Route::is('siswa.detail') ? 'active' : '' }}" href="{{ route('siswa') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>office</title>
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::is('sumbangan') || Route::is('sumbangan.edit') || Route::is('sumbangan.detail') ? 'active' : '' }}" href="{{ route('sumbangan') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>office</title>
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            {{-- disembunyikan dulu --}}
            {{-- <li class="nav-item">
                <a class="nav-link {{ Route::is('dana') || Route::is('praktek.edit') || Route::is('praktek.detail') ? 'active' : '' }}"
            href="{{ route('dana') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <title>office</title>
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::is('pembayaran') || Route::is('pembayaran.update') || Route::is('pembayaran.detail') ? 'active' : '' }}" href="{{ route('pembayaran') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>office</title>
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            {{-- <li class="nav-item">
                <a class="nav-link {{ Route::is('lunas') || Route::is('lunas.edit') || Route::is('lunas.detail') ? 'active' : '' }}"
            href="{{ route('lunas') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <title>office</title>
            ...
            <span class="nav-link-text ms-1">Lunas</span>
            </a>
            </li>

            <li class="nav-item">
                <a class="nav-link {{ Route::is('lunas') || Route::is('lunas.edit') || Route::is('lunas.detail') ? 'active' : '' }}" href="{{ route('lunas') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>office</title>
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="nav-link-text ms-1">Belum Lunas</span>
                </a>
            </li> --}}
            ...
            @else
            <li class="nav-item">
                <a class="nav-link {{ Route::is('user') || Route::is('user.update') || Route::is('user.detail') ? 'active' : '' }}" href="{{ route('user') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
